  ...
  return (
    <MainContainer>
      <ContactOverlayContainer
        className={open ? "contact-overlay-open" : "contact-overlay-closed"}
      >
        <HeaderContainer>
          <HeaderContent>
            <Link
          ...
          <Hero>
            <div
              dangerouslySetInnerHTML={{
                __html: data.allPrismicContact.edges.slice(0, 1).pop().node.data
                  .contact_title.html,
              }}
            />
            <div
              dangerouslySetInnerHTML={{
                __html: data.allPrismicContact.edges.slice(0, 1).pop().node.data
                  .contact_subheading.html,
              }}
            />
            <CopyToClipboard text={"kinanti.desy@gmail.com"}>
              <span
                dangerouslySetInnerHTML={{
                  __html: data.allPrismicContact.edges.slice(0, 1).pop().node
                    .data.contact_links.html,
                }}
              />
            </CopyToClipboard>
          </Hero>
